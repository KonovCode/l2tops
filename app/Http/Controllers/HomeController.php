...
class HomeController extends Controller
{
    public function index() {
        ...
        $weekAgoAndMore = Project::all()->whereBetween('date_open', [Carbon::now()->subDays(8)->toDateString(), Carbon::now()->subDays(60)->toDateString()]);
        ...
        $previousSevenDays = Project::all()->whereBetween('date_open', [Carbon::now()->subDays(1)->toDateString(), Carbon::now()->subDays(8)->toDateString()]);

...
<div class="relative z-0 mb-5 w-full group mx-1">
      <input {{$attributes}} type="{{$type}}" name="{{$name}}" id="{{$id}}" class="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 border-gray-300 appearance-none text-blue-600 dark:text-blue dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" "/>
